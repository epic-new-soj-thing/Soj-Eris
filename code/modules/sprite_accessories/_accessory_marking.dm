...
/*Belly Hands Feet*/
	...
	belly_hands_feet
		...
		species_allowed = list(SPECIES_SABLEKYNE, SPECIES_CINDARITE)
	...
	hands_feet_belly_full_female
		...
		body_parts = list(BP_L_LEG,BP_R_LEG,BP_L_LEG,BP_R_LEG,BP_L_ARM,BP_R_ARM,BP_L_ARM,BP_R_ARM,BP_GROIN,BP_CHEST)
		species_allowed = list(SPECIES_SABLEKYNE)
...
/*Color Bands + Patches*/
	...
	bands
		name = "Color Bands"
		icon_state = "bands"
		body_parts = list(BP_L_LEG,BP_R_LEG,BP_L_LEG,BP_R_LEG,BP_L_ARM,BP_R_ARM,BP_L_ARM,BP_R_ARM,BP_CHEST,BP_GROIN)
	...
	heterochromia
		...
		body_parts = list(BP_HEAD)
		species_allowed = list(SPECIES_HUMAN, , SPECIES_SABLEKYNE, SPECIES_OPIFEX, SPECIES_AKULA, SPECIES_OPIFEX, SPECIES_OPIFEX, SPECIES_KRIOSAN, , SPECIES_NARAMAD, SPECIES_NARAMAD) //This lets all races use the default hairstyles.
...
/*Socks*/
	...
	una_paw_socks
		...
		body_parts = list(BP_L_LEG,BP_R_LEG,BP_L_LEG,BP_R_LEG,BP_L_ARM,BP_R_ARM,BP_L_ARM,BP_R_ARM)
		species_allowed = list(SPECIES_CINDARITE)
...
/*Tiger*/
	...
	tiger_stripes
		name = "Tiger Stripes"
		icon_state = "tiger"
		body_parts = list(BP_L_LEG,BP_R_LEG,BP_L_LEG,BP_R_LEG,BP_L_ARM,BP_R_ARM,BP_CHEST,BP_GROIN)
		species_allowed = list(SPECIES_SABLEKYNE) //There's a tattoo for non-cats
